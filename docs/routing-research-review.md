...
- [Agent-as-a-Router](https://arxiv.org/pdf/2606.22902)는 2026년 6월 arXiv
  preprint로, coding task에서
  ...
  CLI와 다른 조건이 있다.
- [SWE-Router](https://arxiv.org/pdf/2607.00053)는 ICML 2026 code workshop
  논문으로, prompt-only 정보의 Bayes
...
- [Meta-Router](https://openreview.net/forum?id=r0BFucF2dH)는 ICLR 2026 poster로, gold label과
  preference label 사이의 causal correction을 다룬다. preference를 ground truth로
  놓지 않아야 한다는 현재 설계와 맞는다.
- [UniRoute](https://openreview.net/pdf?id=ka82fvJ5f1)는 ICLR 2026 poster로, model feature vector로
...
- [Conformal LLM Routing with Distribution-Free Safety Guarantees](https://aclanthology.org/2026.acl-srw.70/)
  는 ACL 2026 Student Research Workshop 논문으로 cheap model 사용의 violation
  rate를 calibration한다. 두 모델과 GSM8K/MMLU 중심이므로 coding-agent 안전
  보장으로 확대 해석하지 않는다.
...
연구기관들이 참여한 Findings of ACL 2026 연구로, 23,945 prompt에서 만든 391,645
instance, 21 dataset, 33 model, 10 baseline을 비교한다.
[공개 repository](https://github.com/ynulihao/LLMRouterBench)도 제공한다.
...
- [Humans or LLMs as the Judge?](https://aclanthology.org/2024.emnlp-main.474/)는
  ...
  분석한다.
- [Justice or Prejudice?](https://proceedings.iclr.cc/paper_files/paper/2025/hash/fdca08d371e4b6c031397909e20043bd-Abstract-Conference.html)는
  ICLR 2025 논문으로 LLM judge의
...
- [Router fragility 연구](https://arxiv.org/abs/2504.07113)는 현재 preprint 근거로, routing threshold에
